...
public class Student {
	...
	public Student(int rollNo, String studentName, int attendence, int studentRank, int total, char studentClass,
			String mentorName) {
		super();
		this.rollNo = rollNo;
		this.studentName = studentName;
	...
	public String toString() {
		return "Student [rollNo=" + rollNo + ", studentName=" + studentName + ", attendence=" + attendence
				+ ", studentRank=" + studentRank + ", total=" + total + ", studentClass=" + studentClass
